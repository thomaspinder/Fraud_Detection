...
if file_checks[1] > 0:
    ...
    print("Unimportant Variables Writted")
    ...
    fig.savefig("/home/tpin3694/Documents/university/MSc/fundamental/fraud/plots/" + filename + "rf_roc_no_smote.png")
    ...
    fig.savefig("/home/tpin3694/Documents/university/MSc/fundamental/fraud/plots/" + filename + "rf_confusion_no_smote.png")
    data_list.append(results)
else:
    pass

results_df = pd.DataFrame(data_list, columns = ["File","Accuracy", " recall", "precision", "f_score", "auc"])
results_df.to_csv("/home/tpin3694/Documents/university/MSc/fundamental/fraud/data/all_data_random_forest_results_no_smote.csv",
                  index = False)